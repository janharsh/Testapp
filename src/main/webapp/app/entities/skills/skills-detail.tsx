...
export class SkillsDetail extends React.Component<ISkillsDetailProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            Skills [<b>{skillsEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="skills">Skills</span>
            </dt>
            <dd>{skillsEntity.skills}</dd>
          </dl>
          <Button tag={Link} to="/entity/skills" replace color="info">
            <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
          </Button>
          &nbsp;
          <Button tag={Link} to={`/entity/skills/${skillsEntity.id}/edit`} replace color="primary">
